...
*@FileName : CarrierDBDAOSearchVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
*@LastModifyDate : 2022.06.05
*@LastModifier : 
*@LastVersion : 1.0
* 2022.06.05 
* 1.0 Creation
...
public class CarrierDBDAOSearchVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public CarrierDBDAOSearchVOUSQL(){
		setQuery();
		...
		query.append("FileName : CarrierDBDAOSearchVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
