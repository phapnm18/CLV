...
*@FileName : MasterDBDAOMasterVORSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MasterDBDAOMasterVORSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MasterDBDAOMasterVORSQL(){
		setQuery();
		...
		query.append("FileName : MasterDBDAOMasterVORSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
