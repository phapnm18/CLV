...
*@FileName : MasterDBDAOMasterVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MasterDBDAOMasterVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MasterDBDAOMasterVOUSQL(){
		setQuery();
		...
		query.append("FileName : MasterDBDAOMasterVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
