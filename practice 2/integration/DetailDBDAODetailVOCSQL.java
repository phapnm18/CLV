...
*@FileName : DetailDBDAODetailVOCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DetailDBDAODetailVOCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DetailDBDAODetailVOCSQL(){
		setQuery();
		...
		query.append("FileName : DetailDBDAODetailVOCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
