...
*@FileName : DetailDBDAODetailVOUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class DetailDBDAODetailVOUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public DetailDBDAODetailVOUSQL(){
		setQuery();
		...
		query.append("FileName : DetailDBDAODetailVOUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
