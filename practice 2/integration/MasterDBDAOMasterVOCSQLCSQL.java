...
*@FileName : MasterDBDAOMasterVOCSQLCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class MasterDBDAOMasterVOCSQLCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public MasterDBDAOMasterVOCSQLCSQL(){
		setQuery();
		...
		query.append("FileName : MasterDBDAOMasterVOCSQLCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
